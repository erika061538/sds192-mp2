...
```{r}
# Number of democratic and republican candidates running in each state
...
# Plot the result
myPlot3 <- ggplot(candidates_state, aes(x=cand_office_state,y=num_cand))+geom_bar(stat = "identity")
