...
### Topic
We are interested in the `candidates` and `house_elections` tables, looking at the number of candidates over the years, between Democratic and Republican Party, and among states to see which party that states support. 
