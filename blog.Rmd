...
1) Writing a function to filter candidates based on their party affiliation rather than re-writing the same code multiple times. Verbs used: `filter` and `select`
...
2) Next, we want to find the number of candidates over the years. Verbs used: `select`, `group_by`, `summarize`
